...
<?= $this->section('content') ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-wrap" style="max-width:1200px;">
				<div class="table-responsive">
					<div asp-box="fetchApi|layout/list" class="data-tables-wrapper no-footer">
        ...
        <div class="card-footer" asp-box="btn">
            ...
            <template>
                <form id="form-edit-layout" class="p-1" enctype="multipart/form-data">
                    <div class="form-group pt-3">
                        <label><?= lang('Admin.global.name') ?></label>
                        <input type="text" class="form-control mt-1" name="name" placeholder="<?= lang('Admin.global.name') ?>" i-pattern="[a-z0-9-_]" maxlength="32" required>
                    </div>
                    <div class="form-group pt-3">
