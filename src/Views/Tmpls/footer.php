  ...
  <a id="scrollUp" href="javascript:void(0)" style="display:none">
  ...
  <script src="/control/assets/js/runtime.<?= $valid_hash ?>.js"></script>
  <script src="/control/assets/js/vendors.<?= $valid_hash ?>.js"></script>
  <script src="/control/assets/js/lang_<?= $locale . '.' . $valid_hash ?>.js"></script>
  <script src="/control/assets/js/app.<?= $valid_hash ?>.js"></script>
